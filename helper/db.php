...
class helper_plugin_extendpage_db extends DokuWiki_Plugin
{
    /** @var helper_plugin_sqlite */
    protected $sqlite;

    /**
     * helper_plugin_extendpage_db constructor.
     */
    ...
    protected function init()
    {
        ...
        if (!$this->sqlite->init('extendpage', DOKU_PLUGIN . 'extendpage/db/')) {
    ...
    public function getDB($throw = true)
    {
        ...
        if (!$this->sqlite && $throw) {
            throw new ExtendPageException('no sqlite');
        }
        return $this->sqlite;
    }
